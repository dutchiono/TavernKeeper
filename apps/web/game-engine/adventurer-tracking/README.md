...
```
game-engine/adventurer-tracking/
├── README.md (this file)
├── code/
│   ├── types/
...
**See also**: `apps/web/game-engine/inventory-tracking/README.md` section "Hero Minting & Base Weapon Initialization" for additional details.
