 ...
 * 
 * See: apps/web/game-engine/inventory-tracking for the inventory system.
 * See: apps/web/game-engine/combat-system/code/services/combatService.ts for weapon retrieval.
 */
