...
import {
  injectedWallet,
  // metaMaskWallet, // SDK has connection issues - use injectedWallet which detects MetaMask
  phantomWallet,
  rainbowWallet,
  walletConnectWallet,
      ...
      wallets: [
        {
          ...
          wallets: [
            // metaMaskWallet removed - SDK connection issues
            // injectedWallet will detect MetaMask automatically via window.ethereum
            injectedWallet,
            phantomWallet,
            rainbowWallet,
            walletConnectWallet,
