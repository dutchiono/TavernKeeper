...
- **CRITICAL: Hero Minting & Base Weapon Initialization**: 
  ...
  **Example**:
  ...
  This ensures all heroes start with appropriate equipment and the combat system can retrieve their weapons from inventory rather than using defaults. See `apps/web/game-engine/adventurer-tracking/README.md` section "CRITICAL: Initial Weapon Setup for Minted Heroes" for additional details and integration points.
