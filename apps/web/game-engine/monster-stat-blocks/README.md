...
- `apps/web/game-engine/themed-dungeon-generation/` - Link theme monsters to stat blocks
- `apps/web/lib/game-mechanics/monsters/MonsterFactory.ts` - Replace with stat block system
- `apps/web/game-engine/adventurer-tracking/` - Award XP based on monster CR
...
```
game-engine/monster-stat-blocks/
├── README.md (this file)
├── code/
│   ├── types/
