...
- `apps/web/game-engine/themed-dungeon-generation/` - Link combat to dungeon rooms
- `apps/web/game-engine/adventurer-tracking/` - Update adventurer stats after combat
- `apps/web/game-engine/monster-stat-blocks/` - Use monster stat blocks in combat
...
import type { RoomEncounter } from '@/game-engine/themed-dungeon-generation/code/types/dungeon-generation';
