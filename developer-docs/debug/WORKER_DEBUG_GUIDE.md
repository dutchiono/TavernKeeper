...
-- File: apps/web/game-engine/adventurer-tracking/code/database/migration.sql
```
...
- **Fix**: Run `apps/web/game-engine/adventurer-tracking/code/database/migration.sql` in Supabase
