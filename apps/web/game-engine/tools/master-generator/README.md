...
```
apps/web/game-engine/tools/master-generator/
...
- World Generation: `apps/web/game-engine/world-generation-system/code/`
- Dungeon Generation: `apps/web/game-engine/themed-dungeon-generation/code/`
- Item Generation: `apps/web/game-engine/procedural-item-generation/code/`

The tool includes comments indicating where code was ported from (e.g., "Ported from apps/web/game-engine/...") to help track the source.
