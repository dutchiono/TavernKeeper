...
### Game Logging System
**Location**: `game-engine/game-logging-system/`
...
**Location**: `game-engine/world-content-hierarchy/`
...
**Location**: `game-engine/world-generation-system/`
...
**Location**: `game-engine/themed-dungeon-generation/`
...
**Location**: `game-engine/adventurer-tracking/`
...
**Location**: `game-engine/inventory-tracking/`
...
**Location**: `game-engine/monster-stat-blocks/`
...
2. **Create a new subfolder** - Use descriptive names (e.g., `game-engine/feature-name/`)
