        ...
        headers: [
          {
            ...
            value: "connect-src 'self' https://* wss://* http://localhost:* https://explorer-api.walletconnect.com https://*.walletconnect.com https://*.walletconnect.org https://pulse.walletconnect.org https://rpc.monad.xyz https://testnet-rpc.monad.xyz https://farcaster.xyz https://*.farcaster.xyz https://client.farcaster.xyz https://warpcast.com https://client.warpcast.com https://wrpcd.net https://*.wrpcd.net https://privy.farcaster.xyz https://privy.warpcast.com https://auth.privy.io https://*.rpc.privy.systems https://cloudflareinsights.com https://cloud.reown.com *; img-src 'self' blob: data: *; font-src 'self' data:; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; frame-src 'self' https://auth.privy.io https://*.privy.io https://verify.walletconnect.com https://verify.walletconnect.org https://wallet.farcaster.xyz; frame-ancestors 'self' http://localhost:* https://*.tavernkeeper.xyz https://farcaster.xyz https://*.farcaster.xyz https://wallet.farcaster.xyz https://warpcast.com https://client.warpcast.com;",
          },
        ],
      },
    ];
